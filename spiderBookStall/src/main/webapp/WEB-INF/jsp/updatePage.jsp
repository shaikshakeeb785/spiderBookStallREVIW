...
<div align="center">
    ...
    <c:url value="/saveUpdate" var="saveUpdate"></c:url>
    <f:form action="${saveUpdate}" method="post" modelAttribute="customerObject">
        ...
        <f:errors path="pinCode" cssClass="error"/>
        <br>

        <f:button type="submit">SUBMIT</f:button>
    </f:form>
    <c:url value="/profile" var="back"></c:url>
    <a href="${back}">back</a>
</div>
